...
-- INSERT INTO Students (StudentName, Age, Marks) VALUES ('Ravi', 20, 110);
-- ERROR 1644 (45000): Marks cannot be greater than 100!
...
-- OUTPUT:
-- INSERT INTO Students (StudentName, Age, Marks) VALUES ('Sneha', 19, 95);
-- SELECT * FROM StudentLogs;
-- LogID | ActionType | ActionDate           | Description
-- 1     | INSERT      | 2025-10-28 10:45:00 | New student added: Sneha, Marks: 95
...
-- OUTPUT:
-- UPDATE Students SET Marks = 88 WHERE StudentID = 1;
-- SELECT * FROM StudentLogs;
-- LogID | ActionType | ActionDate           | Description
-- 2     | UPDATE      | 2025-10-28 10:47:00 | Marks updated for Sneha from 95 to 88
...
-- SELECT * FROM StudentLogs;
-- LogID | ActionType | ActionDate           | Description
-- 3     | DELETE      | 2025-10-28 10:49:00 | Student deleted: Sneha, Marks: 88

-- ======================================================================
-- Verification
-- View all Students and Logs
