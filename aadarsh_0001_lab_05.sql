...
select o.order_id, o.product_name, o.order_date, c.customer_name, c.city from Customers as c
inner join Orders as o on c.customer_id = o.customer_id where c.city = 'Bangalore';
-- ======================================================================
-- Output:
-- 101	       Laptop	        2023-12-15	  A         	Bangalore
-- 103	       Headphones	    2024-02-20	  A	            Bangalore
-- ======================================================================
...
-- WRITE YOUR QUERY BELOW
select c.customer_id, c.customer_name, c.city, o.order_id, o.product_name, o.order_date from Customers as c
...
-- WRITE YOUR QUERY BELOW
select o.order_id, o.product_name, o.order_date, c.customer_id, c.customer_name, c.city from Orders as o
right join Customers as c on o.customer_id = c.customer_id;
-- ======================================================================
-- Output:
-- 101	 Laptop	       2023-12-15	1	A	Bangalore
-- 103	 Headphones	   2024-02-20	1	A	Bangalore
-- 102	 Smartphone	   2024-01-10	2	B	Delhi
-- 104	 Tablet	       2024-03-05	3	C	Mumbai
-- 			                        4	D	Chennai
-- ======================================================================
...
left join Orders as o on c.customer_id = o.customer_id
union
select c.customer_id, c.customer_name, c.city, o.order_id, o.product_name, o.order_date from Orders as o
